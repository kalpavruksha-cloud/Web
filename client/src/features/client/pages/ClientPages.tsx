...
export function ClientDocumentsPage() {
  ...
  async function downloadDocument(row: ClientDocument) {
    ...
    try {
      ...
      toast({ title: "Document downloaded", message: `${row.name || row.type} is ready.`, type: "success" });
    } catch (err) {
      toast({ title: "Download failed", message: err instanceof Error ? err.message : "Unable to download document", type: "error" });
    } finally {
      setDownloadingId("");
    }
  }
