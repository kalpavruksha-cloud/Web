            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="font-extrabold text-navy-900 dark:text-ivory">Download Kalpavruksha App</p>
                    ...
                    <button
                      type="button"
                      onClick={installApp}
                      className="mt-3 inline-flex items-center justify-center gap-2 rounded-xl bg-forest-700 px-4 py-2 text-xs font-extrabold text-white"
                    >
